  ...
  const renderNoteCard = (note: Note) => {
    ...
    return (
      <div
        ...
        className={`${isEditing && editingNoteData ? getColorClass(editingNoteData.color) : getColorClass(note.color)} break-inside-avoid inline-block w-64 hover:shadow-lg transition-all duration-200 group border cursor-pointer relative rounded-lg overflow-hidden ${
